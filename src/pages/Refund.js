      ...
      <div className="categories__content">
        <Row>
          ...
          <Col lg="10">
            ...
            <h1>Refund</h1>
<p>A buyer can claim a refund of the Transaction Price within 7 days of expiry of the Delivery time if you do not receive the Delivery within the time period agreed in the Transaction. In the event you do not raise a refund claim within the prescribed time you shall be ineligible for a refund.</p>

<p>In cases where the buyer has received the item which is not as described in the listing, the buyer can claim a refund for the entire Transaction Price paid within 7 days from the expiry of the Delivery time. The Company may contact the Users for the purposes of verification. If the refund claim is accepted then the Transaction Price will be refunded to the buyer.</p>

<p>If you fail to receive an item shipped to you on account of providing inadequate or inaccurate shipping address or your non-availability at the address provided or failure to make requisite payment at the time of delivery, the Transaction will be cancelled and the item will be returned to the seller and the Company and the seller will be entitled to recover reasonable compensation for services provided and costs incurred for shipping, handling, couriering, processing your order and any other services provided to you.</p>
                 </div>
          </Col>
        </Row>
      </div>
